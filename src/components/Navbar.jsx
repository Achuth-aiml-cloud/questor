        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-center space-x-8">
              ...
              <Link to="/feedback" className="text-blue-200 hover:text-white px-3 py-2 text-sm font-medium transition duration-300">Feedback</Link>
              <Link to="/chatwithai" className="text-blue-200 hover:text-white px-3 py-2 text-sm font-medium transition duration-300">Ai Assistant</Link>
